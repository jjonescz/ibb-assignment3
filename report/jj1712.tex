...
CMC curve of Model B is worse for most ranks than that of Model A (Figure~\ref{fig:cmc}).
...
We obtain significantly worse results (Table~\ref{tab:metrics}) and we hypothesize that it is either due to insufficient regularization or due to low amount of training data.
...
Our CNN training and evaluation code is available online at \url{https://github.com/jjonescz/ibb-assignment3}.
